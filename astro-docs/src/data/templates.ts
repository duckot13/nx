...
export const templates: Template[] = [
  ...
  },
  {
    ...
    tagline: 'Next.js front end, NestJS API, and shared types in one monorepo.',
    description:
      'A full-stack SaaS starter: a Next.js front end and a NestJS API that share a single typed contract library. Change a DTO once and TypeScript plus Nx affected keep the front end and back end in sync - the workflow Nx Cloud is built to accelerate.',
    category: 'SaaS',
    useCases: ['SaaS', 'Fullstack', 'Backend', 'API'],
    stack: ['Next.js', 'NestJS', 'TypeScript', 'Jest'],
    repo: 'fullstack-template',
    templateArg: 'nrwl/fullstack-template',
    accent: '#8b5cf6',
    accentTo: '#1e1b4b',
    glyph: 'SaaS',
    image: '/docs/templates-media/fullstack.webp',
    status: 'new',
    featured: true,
    highlights: [
      {
        title: 'One contract, both sides',
        body: 'A shared types library is consumed by the web app and the API, so the API response and the UI stay in sync.',
      },
      {
        title: 'Frontend + backend, one graph',
        body: 'The project graph spans both apps - affected runs exactly the tasks a change touches and nothing more.',
      },
      {
        title: 'Built for distribution',
        body: 'A real cross-stack graph is the perfect candidate for Nx Cloud task distribution and remote caching.',
      },
    ],
    whatsInside: [
    ...
    gettingStarted: [
      {
        label: 'Start the API',
        code: 'npx nx run @fullstack-template/api:serve',
      },
      {
        label: 'Start the web app',
        code: 'npx nx run @fullstack-template/web:dev',
      },
      { label: 'Build every project', code: 'npx nx run-many -t build' },
      graphStep,
    ],
    learnMore: [
      { label: 'Why Nx Cloud', href: 'https://nx.dev/ci/intro/why-nx-cloud' },
    ],
  },
  {
    slug: 'remotion',
  ...
  },
  {
    slug: 'nuxt',
    name: 'Nuxt',
    tagline: 'A Nuxt 4 (Vue) app with a shared component library.',
    description:
      'A Nuxt 4 monorepo for Vue developers: file-based routing, server routes, and a shared Vue component library wired in. Everything you need to build a fast Vue product with Nx caching and affected builds behind it.',
    category: 'Fullstack',
    useCases: ['Fullstack', 'Vue', 'SSR', 'Starter'],
    stack: ['Nuxt', 'Vue', 'Vite', 'Vitest'],
    repo: 'nuxt-template',
    templateArg: 'nrwl/nuxt-template',
    accent: '#00dc82',
    accentTo: '#022c22',
    glyph: 'Nuxt',
    image: '/docs/templates-media/nuxt.webp',
    status: 'new',
    featured: false,
    highlights: [
      {
        title: 'Vue, configured',
        body: 'Nuxt 4 with file-based routing and server routes, configured and ready to extend.',
      },
      {
        title: 'Reusable components',
        body: 'A shared Vue library shows the library-first approach that keeps Nuxt apps tidy.',
      },
      {
        title: 'Cached and affected',
        body: 'Nx skips unchanged work locally and in CI so iteration stays fast.',
      },
    ],
    whatsInside: [
    ...
    gettingStarted: [
      {
        label: 'Start the dev server',
        code: 'npx nx run @nuxt-template/web:serve',
      },
      {
        label: 'Build for production',
        code: 'npx nx run @nuxt-template/web:build',
      },
      { label: 'Test every project', code: 'npx nx run-many -t test' },
      graphStep,
    ],
    learnMore: [
      {
        label: 'Nuxt with Nx',
        href: 'https://nx.dev/technologies/vue/nuxt/introduction',
      },
    ],
  },
  {
    slug: 'expo',
    name: 'Expo',
    tagline: 'A React Native mobile app with Expo and shared libraries.',
    description:
      'A cross-platform mobile starter built on Expo and React Native. Screens, navigation, and a shared UI library set up so you can target iOS, Android, and web from one Nx monorepo - and share code with your web apps too.',
    category: 'Mobile',
    useCases: ['Mobile', 'React Native', 'Cross-platform', 'Starter'],
    stack: ['Expo', 'React Native', 'TypeScript'],
    repo: 'expo-template',
    templateArg: 'nrwl/expo-template',
    accent: '#3b82f6',
    accentTo: '#172554',
    glyph: 'Expo',
    image: '/docs/templates-media/expo.webp',
    status: 'new',
    featured: false,
    highlights: [
      {
        title: 'iOS, Android, and web',
        body: 'Expo targets every platform from a single codebase, generated and configured for you.',
      },
      {
        title: 'Share with your web apps',
        body: 'Shared libraries let mobile and web reuse logic and types in the same monorepo.',
      },
      {
        title: 'Nx-powered builds',
        body: 'Caching and affected keep mobile builds - which are slow by nature - as fast as possible.',
      },
    ],
    whatsInside: [
    ...
    gettingStarted: [
      ...
      { label: 'Run on iOS', code: 'npx nx run mobile:run-ios' },
      { label: 'Run on Android', code: 'npx nx run mobile:run-android' },
      graphStep,
    ],
    learnMore: [
      {
        label: 'Expo with Nx',
        href: 'https://nx.dev/technologies/react/expo/introduction',
      },
    ],
  },
];
